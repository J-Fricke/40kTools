...
// Last updated: Faction Pack v1.1 (legal 2026-07-22); MFM 2026-07 v1.1
...
export const UNITS = [
    ...
    // Knight Despoiler — 380/400 (base); gatling variant +25=405/425
    ...
    {id:"desp",       uid:"desp",    unit:"Knight Despoiler",        label:"Base (meltagun)",            pts:380, pts10:null, m:1, W:26, sv:3, inv:5, fnp:null,
        sWs:[[1,3,9,-4,3.5,{}]],
        mWs:[[4,3,20,-3,8,{}],[12,3,9,-3,2,{}],[4,4,8,-1,2,{}]]},
    // Gatling variant: RC arm replaced with gatling+darkflamer (lose RC melee, keep WC+feet)
    {id:"desp_gc",    uid:"desp",    unit:"Knight Despoiler",        label:"Gatling Cannon (+25pts)",    pts:405, pts10:null, m:1, W:26, sv:3, inv:5, fnp:null,
        sWs:[[18,3,6,-2,2,{}],[4.2,3,5,-1,1,{}]],
        mWs:[[4,3,20,-3,8,{}],[4,4,8,-1,2,{}]]},

    // Knight Rampager — 365/380 — all melee have SH1 native (WS 2+)
    // Bloodlust: melee gains DEV after a charge move → _c rows
    {id:"ramp_rc",    uid:"ramp",    unit:"Knight Rampager",         label:"Chainsword",                 pts:365, pts10:null, m:1, W:26, sv:3, inv:5, fnp:null,
        sWs:[[3,3,5,0,1,{}]],
        mWs:[[18,2,9,-3,2,{sh1:1}]]},
    {id:"ramp_wc",    uid:"ramp",    unit:"Knight Rampager",         label:"Warp Claw",                  pts:365, pts10:null, m:1, W:26, sv:3, inv:5, fnp:null,
        sWs:[[3,3,5,0,1,{}]],
        mWs:[[6,2,20,-3,8,{sh1:1}],[12,2,9,-3,2,{sh1:1}]]},
    {id:"ramp_c",     uid:"ramp",    unit:"Knight Rampager",         label:"Charged (Bloodlust +DEV)",   pts:365, pts10:null, m:1, W:26, sv:3, inv:5, fnp:null,
        sWs:[[3,3,5,0,1,{}]],
    ...
    // Cerastus Knight Atrapos — 395 (1st only) — inv5 ALL attacks (no asterisk on sheet)
    {id:"atra",       uid:"atra",    unit:"Cerastus Atrapos",        label:"",                           pts:395, pts10:null, m:1, W:28, sv:3, inv:5, fnp:null,
    ...
    // Cerastus Knight Lancer — 395/415 — inv4 ALL attacks
    {id:"lanc",       uid:"lanc",    unit:"Cerastus Lancer",         label:"Sweep",                      pts:395, pts10:null, m:1, W:28, sv:3, inv:4, fnp:null,
        sWs:[[6,3,6,0,2,{sh2:1}]],
        mWs:[[10,2,10,-2,3,{}]]},
    {id:"lanc_s",     uid:"lanc",    unit:"Cerastus Lancer",         label:"Strike (Lance = w1)",        pts:395, pts10:null, m:1, W:28, sv:3, inv:4, fnp:null,
        sWs:[[6,3,6,0,2,{sh2:1}]],
        mWs:[[5,2,20,-3,8,{w1:1}]]},
    ...
    {id:"brigand",    uid:"brigand", unit:"War Dog Brigand",         label:"Chaincannon + Meltaspear",   pts:140, pts10:null, m:1, W:14, sv:3, inv:5, fnp:null,
    ...
    // Karnivore: all melee SH1 native
    {id:"karnivore",  uid:"karnivore",unit:"War Dog Karnivore",      label:"Slaughterclaw + Chaintalon", pts:155, pts10:null, m:1, W:14, sv:3, inv:5, fnp:null,
        sWs:[[3,3,5,0,1,{}]],
...
export const DETACHMENTS = [
    ...
    {id:"hhl",    name:"Helhunt Lance",                      dp:2, affects:null},
    {id:"bot",    name:"Bastions of Tyranny",                dp:1, affects:null},
    {id:"hw",     name:"Hunting Warpack",                    dp:1, affects:null},
    {id:"icf",    name:"Iconoclast Fiefdom",                 dp:1, affects:null},
];
